...
summary(lm.r)
```
Nilai P-Value = 0.000000003184 < 0.05 (sangat signifikan)

$$Sales = \beta_0 + \beta_1facebook + \varepsilon$$


$$Sales = 11.02329 + 0.20290.facebook + \varepsilon$$ 

Misalnya facebooknya Rp. 3500, berapakah nilai penjualan (sales)?
Persamaan regresi linernya adalah:

$$Sales = 11.02329 + (0.20290*3500) + \varepsilon$$ 
...
summary(lm.y)
```
nilai p-value = 0.00000000000000022 (kecil dari 0,05) -> sangat signifikan


Berdasarkan output diatas bisa dijelaskan bahwa:
Persamaan regresi linernya adalah

$$sales = 8.403306 + 0.048109*youtube$$

Misal youtube = 3500

```{r}
sales.y = 8.403306 + (0.048109*3500)
sales.y
```
...
```
$$Sales = 14.70610 + 0.05228 * newspaper + \varepsilon$$
Misal nilai newspapernya: 3500
maka nilai:

```{r}
sales_n = 14.70610 + (0.05228 * 3500)
sales_n
```
